...
export default function Sidebar() {
    ...
    return (
        <aside className="w-64 border-r border-slate-800 flex flex-col bg-[#111827] fixed h-full z-30 shadow-2xl">
            ...
            <div className="p-6 border-t border-slate-800/50 bg-slate-900/20">
                <div className="flex items-center gap-3 p-3 rounded-2xl border border-transparent hover:bg-slate-800/50 hover:border-slate-700 transition-all cursor-pointer group">
                    ...
                    <div className="flex flex-col min-w-0">
                        <p className="text-sm font-bold text-slate-200 truncate">Alex Chen</p>
                        <p className="text-[10px] text-slate-500 font-black uppercase tracking-tighter">Super Admin</p>
                    </div>
                </div>
            </div>
        </aside>
